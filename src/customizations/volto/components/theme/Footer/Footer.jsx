...
import { Image, Container, List, Segment, Input, Button } from 'semantic-ui-react';
  ...
  <footer className="ccl-footer">
      ...
      <div className="ccl-container ccl-container-flex">
        <CclFooterBlock title={'Copernicus Services'}>
          <div className="ccl-footer-services">
            <div className='ccl-footer-services-row'>
              <Link to="#" className="ccl-service-button ccl-service-button-link ccl-service-button-w ccl-service-button-atmosphere">
                <Image
                  src={AtmosphereImage}
                  height={60}
                />
              ...
              <Link to="#" className="ccl-service-button ccl-service-button-link ccl-service-button-w ccl-service-button-marine">
                <Image
                  src={MarineImage}
                  height={60}
                />
              ...
              <Link to="#" className="ccl-service-button ccl-service-button-link ccl-service-button-w ccl-service-button-land">
                <Image
                  src={LandImage}
                  height={60}
                />
            ...
            <div className='ccl-footer-services-row'>
              <Link to="#" className="ccl-service-button ccl-service-button-link ccl-service-button-w ccl-service-button-security">
                <Image
                  src={SecurityImage}
                  height={60}
                />
              ...
              <Link to="#" className="ccl-service-button ccl-service-button-link ccl-service-button-w ccl-service-button-climate">
                <Image
                  src={ClimateImage}
                  height={60}
                />
              ...
              <Link to="#" className="ccl-service-button ccl-service-button-link ccl-service-button-w ccl-service-button-emergency">
                <Image
                  src={EmergencyImage}
                  height={60}
                />
        ...
        <CclFooterBlock title={'Newsletter'} borderBottom={false}>
            ...
            <div >
              <div class="ccl-form-group">
                <input type="checkbox" id="footer_privacy" name="footerPrivacy" value=""
                  class="ccl-checkbox  ccl-form-check-input" aria-required="true" />
          ...
          <div className="ccl-footer-social">
            <a href="https://www.youtube.com/channel/UCpuwnbuwGG20enAdE50g6TA" target="_blank" rel="noreferrer" aria-label="Youtube"><span className="ccl-icon-youtube"></span></a>
            <a href="https://twitter.com/CopernicusLand" target="_blank" rel="noreferrer" aria-label="Twitter"><span className="ccl-icon-twitter"></span></a>
            <a href="https://www.facebook.com/CopernicusEU" target="_blank" rel="noreferrer" aria-label="Facebook"><span className="ccl-icon-facebook"></span></a>
          </div>
        </CclFooterBlock>
        <CclFooterBlock title={'Implemented by'}>
          ...
          <h3 className="ccl-footer-column-title">Expert support provided by</h3>
    ...
    <div className="ccl-footer-bottom">
      <ul className="ccl-footer-legal">
        <li>
          <a className="ccl-link" href="./disclaimer.html">Disclaimer</a>
        </li>
        <li>
          <a className="ccl-link" href="./data-policy.html">Data policy</a>
        </li>
        <li>
          <a className="ccl-link" href="./personal-data-protection.html">Personal data protection</a>
        </li>
        <li>
          <a className="ccl-link" href="./cookies.html">Cookies</a>
        </li>
        <li>
          <a className="ccl-link" href="./sitemap.html">Sitemap</a>
        </li>
      </ul>
    </div>
  </footer >
