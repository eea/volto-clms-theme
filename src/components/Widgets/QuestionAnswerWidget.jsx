/**
 * QuestionAnswerWidget component.
 * @module components/manage/Widgets/QuestionAnswerWidget
 */
 ...
 */
class QuestionAnswerWidget extends Component {
  /**
   * Property types.
...
export default injectIntl(QuestionAnswerWidget);
