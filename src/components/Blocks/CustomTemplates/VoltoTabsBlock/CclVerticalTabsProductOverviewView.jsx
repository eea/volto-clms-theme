...
const TabsComponent = (props) => {
  const { tabsList = [], activeTab = null, tabs = {}, setActiveTab } = props;
        ...
        {tabsList.map((tab, index) => {
          ...
          return (
            <div
              key={index}
              id={tabHash}
              className={cx('tab', tab === activeTab && 'product-tab-selected')}
            >
...
const CclVerticalTabsProductOverviewView = (props) => {
  return (
    <div className="ccl-container ccl-container-flex tab-container tabs-vertical-product">
      <TabsComponent {...props} />
...
export default compose(
  ...
  withScrollToTarget,
)(withRouter(CclVerticalTabsProductOverviewView));
