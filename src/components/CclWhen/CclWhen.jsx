...
const TimeZone = ({ br_in_timezone = false }) => {
  return (
    <span> {br_in_timezone && <br />} Time zone: Copenhagen, Denmark</span>
  );
};
              ...
              <span className="end">
                ...
                {!whole_day && (
                  <>
                    {/* Plone has an optional word based on locale here */}
                    <span> </span>
                    <span className="end-time">{cclTimeFormat(end)}</span>
                  </>
                )}
              </span>
            </>
          )}
          <TimeZone br_in_timezone={br_in_timezone} />
        </>
      ) : (
        <>
          {whole_day && (
